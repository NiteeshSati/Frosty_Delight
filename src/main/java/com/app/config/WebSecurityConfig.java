...
public class WebSecurityConfig {
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		...
		//.antMatchers("/cart/usercart").permitAll()
		.antMatchers("/category/{id}/products").permitAll()
		.antMatchers("/products/view","/users/**","/users", "/auth/**","/products/**","/category/**", "/swagger*/**", "/v*/api-docs/**").permitAll() // enabling global
																										// access to all
																										// urls with
																										// /auth
