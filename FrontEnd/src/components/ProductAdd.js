...
function ProductAdd() {
    let [product,setProduct] = useState({ productName:"",price:"",description:"",availableItemCount:""});
  ...
  // }
    ...
    const handleChange2=(event)=>{
      const {name,value}=event.target;
      setcatId({catId,[name]:value})
  }

    const addProduct=()=>{
        console.log(product)
        VendorServices.AddProduct(product,catId).then((resp)=>{
          ...
          <MDBCard className="my-4 shadow-3">
            <MDBRow className="g-0">
              <MDBCol md="4" className="d-xl-block bg-image h-100">
                <MDBCardImage src="https://jessicainthekitchen.com/wp-content/uploads/2022/03/Avocado-Ice-Cream6525.jpg" alt="Sample photo" fluid />
              ...
              <MDBCol md="6">
                <MDBCardBody className="p-md-5 text-black">
                  ...
                  <MDBInput label='CatId' name='CatId' type='number' className="mb-4" size="lg" onChange={handleChange2}/>
